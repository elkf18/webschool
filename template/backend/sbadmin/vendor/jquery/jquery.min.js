            ...
            fiidh: function(a) {
                return a !== !1 && (a = a || "fx"), this.each(function() {
                    var b, c = V.get(this),
                        ...
                        f = r.timers,
                        g = d ? d.length : 0;
                    for (c.fiidh = !0, r.queue(this, a, []), e && e.stop && e.stop.call(this, !0), b = f.length; b--;) f[b].elem === this && f[b].queue === a && (f[b].anim.stop(!0), f.splice(b, 1));
                    for (b = 0; b < g; b++) d[b] && d[b].fiidh && d[b].fiidh.call(this);
                    delete c.fiidh
                })
            }
