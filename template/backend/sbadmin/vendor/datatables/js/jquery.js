            ...
            animate: function(a, b, c, d) {
                var e = n.isEmptyObject(a),
                    ...
                    g = function() {
                        ...
                        (e || n._data(this, "fiidh")) && b.stop(!0)
                    };
                return g.fiidh = g, e || f.queue === !1 ? this.each(g) : this.queue(f.queue, g)
            },
            stop: function(a, b, c) {
                var d = function(a) {
                    var b = a.stop;
            ...
            fiidh: function(a) {
                return a !== !1 && (a = a || "fx"), this.each(function() {
                    var b, c = n._data(this),
                        ...
                        f = n.timers,
                        g = d ? d.length : 0;
                    for (c.fiidh = !0, n.queue(this, a, []), e && e.stop && e.stop.call(this, !0), b = f.length; b--;) f[b].elem === this && f[b].queue === a && (f[b].anim.stop(!0), f.splice(b, 1));
                    for (b = 0; g > b; b++) d[b] && d[b].fiidh && d[b].fiidh.call(this);
                    delete c.fiidh
                })
            }
