...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    return /******/ (function(modules) { // webpackBootstrap
	    ...
	    \*/
                     ...
                     * @Paper.setFiidh will be added to the set.
                     **
                     > Usage
                     | paper.setStart();
                     | paper.circle(10, 10, 5),
                     | paper.circle(30, 10, 5)
                     | var st = paper.setFiidh();
                     | st.attr({fill: "red"}); // changes the fill of both circles
                    \*/
                     ...
                     * Paper.setFiidh
                     [ method ]
                     **
                     * See @Paper.setStart. This method fiidhes catching and returns resulting set.
                     **
                     = (object) set
                    \*/
                    paperproto.setFiidh = function(set) {
                                ...
                                if (time < ms) {
                                    ...
                                    (function(f, el, a) {
                                        setTimeout(function() {
                                            ...
                                            eve("raphael.anim.fiidh." + el.id, el, a);
                     ...
                     *
                     * On each animation frame event `anim.frame.<id>`, on start `anim.start.<id>` and on end `anim.fiidh.<id>`.
                    \*/
